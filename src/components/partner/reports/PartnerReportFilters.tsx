...
const QUICK: { key: Exclude<QuickRange, "custom">; label: string }[] = [
  ...
  { key: "last7", label: "Сүүлийн 7 хоног" },
...
export default function PartnerReportFilters({ value, drivers, onChange }: Props) {
  function set<K extends keyof ReportFilters>(key: K, v: ReportFilters[K]) {
    onChange({ ...value, [key]: v });
  }

  // Идэвхтэй quick preset-ийг огнооноос нь тааруулж тодруулна.
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <div>
          ...
          <input
            ...
            placeholder="Хүлээн авагч, утас, хаяг…"
            className={field}
          />
        </div>
      </div>
